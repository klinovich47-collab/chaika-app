...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=39'));
...
console.log('Prepared CHAIKA production build: responsive iOS/Android polish (rev=39).');
