...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=26'));
...
console.log('Prepared CHAIKA production build with readable categories and event thumbnails (rev=26).');
