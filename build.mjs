...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=32'));
...
console.log('Prepared CHAIKA production build with reliable map double-tap zoom (rev=32).');
