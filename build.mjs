...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=6'));
await writeFile('dist/app.js', `${app}\n\n${live}\n\n${enhancements}\n\n${safetyShare}\n`);
console.log('Prepared CHAIKA production build with live events, hardened mixed-script moderation and Telegram event deep links (rev=6).');
