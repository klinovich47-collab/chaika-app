...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=28'));
...
console.log('Prepared CHAIKA production build with automatic event expiry and refresh (rev=28).');
