...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=21'));
...
console.log('Prepared CHAIKA production build with live museum exhibitions (rev=21).');
