...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=47'));
...
console.log('Prepared CHAIKA production build: clean keyless map + investor demo events (rev=47).');
