...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=2'));
await writeFile('dist/app.js', `${app}\n\n${live}\n\n${enhancements}\n`);
console.log('Prepared CHAIKA static build with Supabase integration, frontend enhancements and bundle rev=2.');
