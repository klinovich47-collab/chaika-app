...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=34'));
...
console.log('Prepared CHAIKA production build with fail-closed user-event moderation (rev=34).');
