...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=9'));
await writeFile('dist/app.js', `${app}\n\n${live}\n\n${enhancements}\n\n${safetyShare}\n\n${mapStress}\n\n${eventChat}\n`);
console.log('Prepared CHAIKA production build with adaptive clustering, stress mode and Telegram event chats (rev=9).');
