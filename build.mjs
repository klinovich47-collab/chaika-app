...
// Restored 2026-08-21 people-only app. Only basemap appearance changed in rev56.
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=56'));
...
console.log('Prepared CHAIKA production build: clean OpenFreeMap Bright basemap (rev=56).');
