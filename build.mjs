...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=8'));
await writeFile('dist/app.js', `${app}\n\n${live}\n\n${enhancements}\n\n${safetyShare}\n\n${mapStress}\n`);
console.log('Prepared CHAIKA production build with adaptive clustering, long-press placement, dark map and hidden stress mode (rev=8).');
