...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=7'));
await writeFile('dist/app.js', `${app}\n\n${live}\n\n${enhancements}\n\n${safetyShare}\n`);
console.log('Prepared CHAIKA production build with weekly discovery, live events, hardened moderation and Telegram event deep links (rev=7).');
