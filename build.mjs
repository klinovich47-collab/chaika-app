...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=4'));
await writeFile('dist/app.js', `${app}\n\n${live}\n\n${enhancements}\n\n${safetyShare}\n`);
console.log('Prepared CHAIKA production build with Supabase, map enhancements, hardened moderation and Telegram event deep links (rev=4).');
