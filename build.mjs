...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=46'));
...
console.log('Prepared CHAIKA production build: restored CARTO Voyager basemap (rev=46).');
