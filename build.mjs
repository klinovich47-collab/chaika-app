...
await writeFile('dist/index.html', index.replace('./app.js?rev=1', './app.js?rev=27'));
...
console.log('Prepared CHAIKA production build with separate moderator permissions (rev=27).');
